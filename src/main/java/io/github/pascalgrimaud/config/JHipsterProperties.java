...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "jhazsess@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "jhazsess API";

        private String description = "jhazsess API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "jhazsess";
